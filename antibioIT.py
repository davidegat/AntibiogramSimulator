...
class AntibiogramSimulation:
    def __init__(self, root):
        ...
        self.root = root
        self.root.title("Simulazione dell'Antibiogramma")
        ...
        self.antibiotic_names = ["Amoxicillina", "Ciprofloxacina", "Eritromicina"]
        self.bacteria_names = [
            "\nColtura di Sangue\n\nAggiungi i tre antibiotici e\nattendi il risultato",
            "\nColtura di Urine\n\nAggiungi i tre antibiotici e\nattendi il risultato",
            "\nColtura di Espettorato\n\nAggiungi i tre antibiotici e\nattendi il risultato",
            "\nColtura di Feci\n\nAggiungi i tre antibiotici e\nattendi il risultato",
            "\nColtura di Tampone Ferita\n\nAggiungi i tre antibiotici e\nattendi il risultato"
        ]
        ...
        self.day_counter_label = ttk.Label(root, text=f"Giorno\n{self.days_remaining}")
    ...
    def create_widgets(self):
        ...
        self.random_label = ttk.Label(self.root, text="Esempio di\ncoltura", cursor="hand2", font=self.fixed_font2)
    ...
    def update_counter_label(self):
        self.day_counter_label["text"] = f"Giorno\n{self.days_remaining}"
        if self.days_remaining >= 3:
            self.display_statistics()
                
    def open_image_window(self, event):
        image_window = tk.Toplevel(self.root)
        image_window.title("Coltura e antibiogramma")
    ...
    def display_statistics(self):
        ...
        statistics_window.title("Risultato antibiogramma")

        table = ttk.Treeview(statistics_window, columns=("Antibiotico", "Sensibilità"), show="headings")
        table.heading("#1", text="Antibiotico")
        table.heading("#2", text="Sensibilità")
        table.pack()

        data = [("Amoxicillina", "Resistente"),
                ("Ciprofloxacina", "Parzialmente Sensibile"),
